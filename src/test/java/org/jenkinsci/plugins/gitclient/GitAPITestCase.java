...
public abstract class GitAPITestCase extends TestCase {
    ...
    public void test_setRemoteURL() throws Exception {
        ...
        assertTrue("remote URL has not been updated",
            remotes.contains("origin\tgit@github.com:ndeloof/git-client-plugin.git"));
    }
    ...
    public void test_list_branches() throws Exception {
        ...
        Collection names = Collections2.transform(branches,
                new Function<Branch, String>() {
    ...
    public void test_get_HEAD_revision() throws Exception {
        ...
        String sha1 = launchCommand(
                "git ls-remote --heads https://github.com/jenkinsci/git-client-plugin.git refs/heads/master")
                          .substring(0, 40);
    ...
    public void test_hasGitRepo_without_git_directory()
        throws Exception {
        assertFalse("Empty directory has a Git repo", git.hasGitRepo());
    }

    public void test_hasGitRepo_with_invalid_git_repo()
        throws Exception {
    ...
    private String launchCommand(File workdir, String args)
        throws IOException, InterruptedException {
        return doLaunchCommand(workdir, args.split(" "));
    }

    private String doLaunchCommand(File workdir, String... args)
        throws IOException, InterruptedException {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        new Launcher.LocalLauncher(listener).launch().pwd(workdir).cmds(args).envs(env).stdout(out).join();
