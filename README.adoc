...
Other host key verification strategies can be configured from the user interface and then viewed with the "View Configuration" button in the configuration as code plugin page.
